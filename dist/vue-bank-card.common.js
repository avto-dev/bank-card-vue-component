...
exports.default = void 0;
var withParams = Object({"NODE_ENV":"production","VUE_APP_IMAGE_CDN":"//cdn.jsdelivr.net/gh/avto-dev/bank-card-vue-component@latest/public","BASE_URL":"/"}).BUILD === 'web' ? __webpack_require__("cb69").withParams : __webpack_require__("0234").withParams;
...
/* harmony default export */ var commonMixin = ({
  ...
  computed: {
    ...
    imagePath: function imagePath() {
      return "//cdn.jsdelivr.net/gh/avto-dev/bank-card-vue-component@latest/public";
    }
  },
  methods: {
    /**
